...
<body>
    ...
    <div class="container-fluid">
        <div class="card mb-8">
            <div class="row g-0">
            <div class="col-md-4">
                <img src="images/medecin2.jpg" class="img-fluid rounded-start" alt="...">
                <br><br>
                <div>
                    <h4 class="card-title">&nbsp;Bertrand Lelouche</h4>
                    <table>
                        <tr>
                            <td><font size="+1">&nbsp;Salle :</font></td>
                            <td><font size="+1">&nbsp;EM-205</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><font size="+1">&nbsp;bertrand.lelouche@omnessante.fr</font></td>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <ul>
                        ...
                        <li><b>1988-1991 : Diplôme d'études spécilisées Cardiologie :</b> Université Sorbonne Paris</li>
                    </ul>
                    <h5>Expérience :</h5>
                    <ul>
                        <li><b>1991-1994 : Résident en médecine interne :</b> Clinique Mayo</li>
                        <li><b>1994-1998 : Médecin Urgentiste : </b>Hôpital européen George Pompidou</li>
                        <li><b>1998-présent : Médecin-déparetment de cardiologie :</b> Hôpital européen George Pompidou</li>
                    </ul>
                    <br>
                    Contacter en ligne : &nbsp;
