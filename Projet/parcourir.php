  ...
  <div class="container">
    <div class="row">
      <div class="col-md d-flex justify-content-center">
        <div class="card cardtrans" stysle="width: 18rem;">
          <img class="card-img-top" src="images/generaliste.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Médecin généraliste</h5>
            <p class="card-text">Touvez le rendez vous qui vous convient le mieux avec un médecin généraliste.</p>
            <a href="listeMedGen.php" class="btn btn-primary">Trouver mon rendez-vous</a>
          </div>
        </div>
      </div>
      <div class="col-md d-flex justify-content-center">
        <div class="card cardtrans" style="width: 18rem;">
          <img class="card-img-top" src="images/specialiste.jpg" alt="Card image cap">
          <div class="card-body">
