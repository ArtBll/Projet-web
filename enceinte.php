    ...
    <div class="container-fluid">
        <div class="card mb-8">
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h4 class="card-title">Biologie de la femme enceinte :</h4>
                        <br>
                        <p>Examens et dépistage permettant de s’assurer du bon déroulement et de la bonne tolérance de la grossesse ainsi que de vérifier l’absence d’infections en cours de grossesse.</p>
                        Contacter en ligne : &nbsp;
