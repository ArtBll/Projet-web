    ...
    <div class="container-fluid">
        <div class="card mb-8">
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h4 class="card-title">Analyse sanguine :</h4>
                        <br>
                        <p>Abstenez vous de manger au moins 12 h avant la prise de sang. L’eau est la seule chose qu’il est possible de consommer. Il est également recommandé d’éviter le tabac et les activités physiques intenses. Mangez et buvez un peu dans les plus brefs délais après la prise de sang afin de recouvrer des forces et de limiter les risques de malaise.
Une vérification de l’ordonnance et de l’identité du patient est effectuée avant d’effectuer la prise de sang.</p>
                        Contacter en ligne : &nbsp;
