...
<body>
    ...
    <div class="container">
        ...
        <br>
        <h4>Portes Ouvertes de Omnès Santé</h4>
        <p class="text-justify">Vous êtes les bienvenus aux portes ouverte de Omnès Santé les <b>samedis et dimaches 4 et 5 juin</b>. Venez rencontrer nos professionnels de santé (médecins génnéralistes, médecins spécialistes..). Nous vous invitons aussi a visiter notre laboratoire d'analyse médical pour découvir les métiers qui y sont pratiqués (analyse sanguine, dépistage, imagerie..) </p>
        <img src="images/portes.jpg" class="img-fluid">
        <br><br><br>
